        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div className="space-y-12">
            ...
            <div className="space-y-10">
              ...
              <div>
                <h4 className="text-xl font-black uppercase text-[#ffcc00] mb-2">03. Custom Belgian Block & Aprons</h4>
                <p className="text-gray-400 font-bold leading-relaxed">Specializing in hand-laid cobblestone and Belgian block transitions that define the Windsor Farms and Fairfax aesthetic.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#1a1a1a] p-12 border-l-[10px] border-[#ffcc00] shadow-2xl self-center">
            ...
            <p className="text-gray-300 font-bold leading-relaxed mb-8">
              "When we pull onto a residential job site, we treat it like a legacy project. Whether it's a long rural drive in Goochland or a tight estate entry in 23221, the 6-inch stone standard is non-negotiable."
            </p>

          ...
          <div className="space-y-12 text-left">
            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <p className="text-gray-400 font-bold leading-relaxed text-left">The skeleton of your driveway. We use heavy-duty compaction to ensure a base that supports heavy SUVs without rutting.</p>
              </div>
              <div>
                <h4 className="text-xl font-black uppercase text-[#ffcc00] mb-2 text-left">03. Custom Belgian Block & Aprons</h4>
                <p className="text-gray-400 font-bold leading-relaxed text-left">Specializing in hand-laid cobblestone and Belgian block transitions for elite curb appeal.</p>
              </div>
            </div>
          </div>

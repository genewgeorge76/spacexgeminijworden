      ...
      <section className="py-24 px-6 bg-black text-left">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 text-left">
            ...
            <div className="space-y-10 text-left">
              <div className="text-left">
                ...
                <p className="text-gray-400 font-bold leading-relaxed text-left">
                  We assess Virginia's clay and soil density before the first stone is dropped to prevent the sinking and shifting common with "budget" contractors.
                </p>
              </div>
              <div className="text-left">
          ...
          <div className="bg-[#1a1a1a] p-12 border-l-[10px] border-[#ffcc00] shadow-2xl self-center text-left">
            ...
            <p className="text-gray-300 font-bold leading-relaxed mb-8 text-left uppercase tracking-tighter italic">

...
{/* NEW: LIABILITY & COMPLIANCE SECTION */}
      <section className="py-24 px-6 max-w-7xl mx-auto border-t border-gray-800">
        <div className="bg-[#1a1a1a] p-10 border-l-8 border-red-600 shadow-2xl">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            We don't just paint lines; we protect your interests as a business owner. 
            By utilizing <span className="text-white font-bold">TTP-1952 federal specification paint</span> 
            and strictly adhering to the <a href="https://www.ada.gov/law-and-regs/design-standards/2010-stds/" target="_blank" className="text-[#ffcc00] underline">2010 ADA Standards</a>, 
            we shield you from "drive-by" lawsuits and non-compliance fines.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-black/50 p-6 border border-gray-800">
              ...
              <p className="text-sm text-gray-400">Exclusively using <a href="https://neyra.com/" target="_blank" className="underline">Neyra Industries</a> and <a href="https://sealmaster.net/" target="_blank" className="underline">SealMaster</a> high-solids emulsions. No watered-down mixes.</p>
            </div>
            <div className="bg-black/50 p-6 border border-gray-800">

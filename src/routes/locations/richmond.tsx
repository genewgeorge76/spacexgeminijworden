      ...
      <section className="py-24 px-6 bg-[#1a1a1a] border-b-[10px] border-[#ffcc00]">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-7xl font-black uppercase text-[#ffcc00]">
            Richmond <br/> Asphalt Authority
          </h1>
          <p className="text-2xl text-gray-400 italic font-bold">
            The premier paving partner for Downtown, The Fan, and the Museum District.
          </p>
        </div>
      </section>
    </main>

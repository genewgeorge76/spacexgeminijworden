      ...
      <section className="relative py-32 px-6 bg-[#1a1a1a] border-b-[15px] border-[#ffcc00] overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10 text-left">
          ...
          <h1 className="text-8xl font-black uppercase text-[#ffcc00] leading-[0.9] tracking-tighter text-left">
            DINWIDDIE <br /> <span className="text-white italic">HEAVY DUTY</span>
          </h1>
          <p className="text-3xl text-gray-400 italic font-bold mt-10 max-w-4xl leading-snug">
            J. Worden & Sons Asphalt Paving: Farm-grade asphalt engineered specifically to withstand heavy agricultural equipment and long Dinwiddie winters.
          </p>
        </div>
      </section>
        ...
        <div className="bg-[#1a1a1a] p-12 border-l-[10px] border-[#ffcc00] grid md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-xl text-gray-400 font-bold leading-relaxed text-left">
              When tractors and combines are rolling daily, a standard residential driveway will crumble. We excavate deep and stabilize your Dinwiddie sub-grade for ultimate load-bearing capacity.
            </p>
          </div>
          <div className="border border-gray-800 p-8 text-center self-center bg-black/50">
            <p className="text-sm font-black uppercase tracking-[0.3em] text-gray-500 mb-2 italic">Southern Dispatch From HQ:</p>

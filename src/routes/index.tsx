          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-white font-bold text-2xl tracking-tighter uppercase">
                J. Worden <span className="text-orange-500">& Sons</span>
              </span>
            </div>
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="tel:8042442609" className="bg-orange-500 hover:bg-orange-600 text-black px-6 py-2 rounded-md font-bold transition-all transform hover:scale-105 shadow-lg shadow-orange-500/30">
                804-244-2609
              </a>
            </div>
          </div>
      ...
      <section className="hero-video-container pt-20">
        ...
        <div className="hero-content px-4 w-full max-w-5xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-6 text-white drop-shadow-2xl uppercase leading-tight">
            4 Generations of <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-yellow-500">Infrastructure Authority</span>
          </h1>
          ...
          <div className="cta-buttons flex flex-col sm:flex-row justify-center items-center gap-6 mt-8">
            <a href="tel:8042442609" className="btn-911 flex items-center text-xl px-10 py-5 shadow-2xl hover:shadow-orange-500/50 uppercase tracking-wide border border-orange-400">
          ...
          <div className="grid md:grid-cols-3 gap-10 mt-16">
            <div className="bg-stone-50 border border-stone-200 p-10 rounded-2xl shadow-xl hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-stone-600 text-lg leading-relaxed">
                Trusted by national brands including <strong>KFC, Arby’s, and Taco Bell</strong>. Our commercial structural standards are tested daily by heavy traffic.
              </p>
            </div>
      ...
      <section id="contact" className="py-24 bg-orange-500 text-black relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            <a href="tel:8042442609" className="w-full sm:w-auto flex items-center justify-center bg-black text-white text-2xl px-12 py-6 rounded-md font-black uppercase tracking-wider hover:bg-stone-900 transition-all transform hover:scale-105 shadow-2xl group">

    ...
    <main className="min-h-screen bg-[#111111]">
      <section className="flex flex-col md:flex-row min-h-[85vh] border-b-[10px] border-[#ffcc00]">
        ...
        <div className="flex-1 bg-[#1a1a1a] p-12 border-r border-[#ffcc00]/20 flex flex-col justify-center">
          ...
          <p className="text-xl mb-8 font-bold text-gray-300 uppercase">Vetted by KFC, Taco Bell, and Winn-Dixie.</p>
          ...
          <a href="tel:8044461296" className="bg-[#ffcc00] text-black text-center py-6 font-black uppercase text-3xl hover:bg-white transition-all">
            804-446-1296
          </a>
        </div>
        ...
        <div className="flex-1 bg-white text-black p-12 flex flex-col justify-center">
          ...
          <a href="tel:8044461296" className="bg-black text-white text-center py-6 font-black uppercase text-3xl hover:bg-[#ffcc00] hover:text-black transition-all">
            Request Quote
          </a>
        </div>
      </section>

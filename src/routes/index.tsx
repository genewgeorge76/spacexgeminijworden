    ...
    <main className="min-h-screen bg-[#111111] font-sans text-white">
      <section className="flex flex-col md:flex-row min-h-[85vh] border-b-[10px] border-[#ffcc00]">
        ...
        <div className="flex-1 bg-[#1a1a1a] p-12 border-r border-[#ffcc00]/20 flex flex-col justify-center">
          <h1 className="text-[#ffcc00] text-7xl mb-6 uppercase font-black tracking-tighter">Commercial<br/>Infrastructure</h1>
        ...
        <div className="flex-1 bg-white text-black p-12 flex flex-col justify-center">
          <h2 className="text-7xl mb-6 uppercase font-black tracking-tighter">Residential<br/>Estates</h2>
          <div className="flex items-center gap-6 mb-10">
            <div className="bg-[#7ac142] text-white p-6 text-center leading-none font-black rounded-lg shadow-lg uppercase">HOUZZ<br/>2024-2026</div>

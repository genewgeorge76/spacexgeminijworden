...
export default function Header() {
  return (
    <header className="bg-[#111] border-b-[3px] border-[#c8a84b] sticky top-0 z-[100]">
      <div className="max-w-[1100px] mx-auto flex items-center justify-between px-6 py-4">
        ...
        <nav className="hidden md:flex gap-6">
          <Link to="/" hash="authority" className="text-white text-[0.85rem] uppercase tracking-wider hover:text-[#c8a84b] transition-colors">About</Link>
          ...
          <Link to="/" hash="authority" className="text-white text-[0.85rem] uppercase tracking-wider hover:text-[#c8a84b] transition-colors">Our Standard</Link>
